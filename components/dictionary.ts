...
export const dict = {
  es: {
    ...
    hero: {
      ...
      body: "Conectamos modelos de IA conversacional a tu punto de venta e inventario. Contestan chats, arman órdenes, coordinan entregas, generan reportes y gestionan turnos, sin que nadie tenga que estar pendiente.",
  ...
  en: {
    ...
    hero: {
      ...
      body: "We connect conversational AI models to your point of sale and inventory. They answer chats, create orders, coordinate deliveries, generate reports and manage shifts, without anyone having to keep watch.",
